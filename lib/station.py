...
stats_policy = nla_policy_array(nl80211.STA_INFO_MAX + 1)
stats_policy[nl80211.STA_INFO_INACTIVE_TIME].type = NLA_U32
stats_policy[nl80211.STA_INFO_RX_BYTES].type = NLA_U32
stats_policy[nl80211.STA_INFO_TX_BYTES].type = NLA_U32
stats_policy[nl80211.STA_INFO_RX_PACKETS].type = NLA_U32
stats_policy[nl80211.STA_INFO_TX_PACKETS].type = NLA_U32
stats_policy[nl80211.STA_INFO_SIGNAL].type = NLA_U8
stats_policy[nl80211.STA_INFO_SIGNAL].signed = True
stats_policy[nl80211.STA_INFO_SIGNAL_AVG].type = NLA_U8
stats_policy[nl80211.STA_INFO_SIGNAL_AVG].signed = True
stats_policy[nl80211.STA_INFO_T_OFFSET].type = NLA_U64
stats_policy[nl80211.STA_INFO_TX_BITRATE].type = NLA_NESTED
stats_policy[nl80211.STA_INFO_TX_BITRATE].single = True
stats_policy[nl80211.STA_INFO_RX_BITRATE].type = NLA_NESTED
stats_policy[nl80211.STA_INFO_RX_BITRATE].single = True
stats_policy[nl80211.STA_INFO_LLID].type = NLA_U16
stats_policy[nl80211.STA_INFO_PLID].type = NLA_U16
stats_policy[nl80211.STA_INFO_PLINK_STATE].type = NLA_U8
stats_policy[nl80211.STA_INFO_TX_RETRIES].type = NLA_U32
stats_policy[nl80211.STA_INFO_TX_FAILED].type = NLA_U32
stats_policy[nl80211.STA_INFO_STA_FLAGS].minlen = 8
stats_policy[nl80211.STA_INFO_LOCAL_PM].type = NLA_U32
stats_policy[nl80211.STA_INFO_PEER_PM].type = NLA_U32
stats_policy[nl80211.STA_INFO_NONPEER_PM].type = NLA_U32
stats_policy[nl80211.STA_INFO_CHAIN_SIGNAL].type = NLA_NESTED
stats_policy[nl80211.STA_INFO_CHAIN_SIGNAL].list_type = NLA_U8
stats_policy[nl80211.STA_INFO_CHAIN_SIGNAL].signed = True
stats_policy[nl80211.STA_INFO_CHAIN_SIGNAL_AVG].type = NLA_NESTED
stats_policy[nl80211.STA_INFO_CHAIN_SIGNAL_AVG].list_type = NLA_U8
stats_policy[nl80211.STA_INFO_CHAIN_SIGNAL_AVG].signed = True
stats_policy[nl80211.STA_INFO_RX_BYTES64].type = NLA_U64
stats_policy[nl80211.STA_INFO_TX_BYTES64].type = NLA_U64
stats_policy[nl80211.STA_INFO_BEACON_LOSS].type = NLA_U32
stats_policy[nl80211.STA_INFO_CONNECTED_TIME].type = NLA_U32
stats_policy[nl80211.STA_INFO_BSS_PARAM].type = NLA_NESTED
...
class station(nl80211_managed_object):
	...
	def put_obj_id(self, msg):
		nla_put_u32(msg._msg, nl80211.ATTR_IFINDEX, self._ifidx)
		nla_put(msg._msg, nl80211.ATTR_MAC, self._mac)
